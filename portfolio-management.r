...
data <- read_excel("C:/Users/ADMIN/Project Fund/Data/VCBFBCF PORTFOLIO DATA.xlsx",
                   sheet = "NAVPS")
...
Port <- read_excel("C:/Users/ADMIN/Project Fund/Data/VCBFBCF PORTFOLIO DATA.xlsx", 
                                     sheet = "PORTFOLIO")
